<template>
  ...
  >
    ...
    <div class="footer_content grid items-center">
      <h3 class="row-start-1 row-end-1 col-start-1 col-end-1 ml-4 text-sm">{{ content.message }}</h3>
      <h4
      ...
      <SocialComponentVue
        class="row-start-1 row-end-1 col-start-2 col-end-2 w-max justify-self-end"
...
<script>
import SocialComponentVue from "../SocialComponentVue";
export default {
  components: { SocialComponentVue },
  props: {
    content: {
      type: Object,
      required: true,
