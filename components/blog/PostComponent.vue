<template>
  <div :class="`post max-w-xl md:max-w-none md:w-9/12 2xl:max-w-7xl my-0 mx-auto pb-10 pt-24 ${$device.isDesktop ? 'md:pt-20' : ''} px-6 prose prose-sm lg:prose-lg xl:prose-xl`">
    <Icon
