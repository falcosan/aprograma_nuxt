  ...
  >
    <NuxtLink :to="postLink" class="teaser-link">
      ...
      >
        <component
          :is="lookFile()"
          :class="`teaser-file w-full h-60 sm:h-72 object-cover object-center select-none ${$parent.blok.row_container ? 'md:h-48 lg:h-72 xl:h-80' : 'md:h-80 lg:h-full lg:w-1/2'}`"
