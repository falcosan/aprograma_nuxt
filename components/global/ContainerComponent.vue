  ...
  >
    ...
    >
      <div
        ...
        :class="`${component.component.toLowerCase()}-container p-5 md:p-10${$device.isDesktop && blok.effects ? ' transform transition duration-200 hover:shadow-lg hover:scale-105' : ''}${component.row_container ? '' : ' col-start-1'}`"
      >
        <component
