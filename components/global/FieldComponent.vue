<template>
  <div class="field-item relative grid mb-5" :style="`background-color: ${blok.background_color.color};`">
    ...
    <component
      ...
      :type="blok.type"
      :class="`field-input w-full relative z-20 p-2 rounded resize-none shadow-inner text-black bg-gray-100 ${isMessage ? 'h-40' : 'h-10 leading-10'} ${fieldError() ? 'border-dotted border-2 border-red-600' : 'border border-gray-500'}`"
