  ...
  <section :class="`${blok.name.toLowerCase()}-page p-5`">
    ...
    <div class="page-components flex flex-wrap -m-2.5">
      <div
        ...
        :class="`${component.component.toLowerCase()}-content mx-2.5 mt-2.5 ${component.component.toLowerCase() === 'container' && component.slider_mode === 'slider' ? 'overflow-hidden' : ''} ${index === blok.body.length - 1 ? 'mb-2.5' : 'mb-8'}`"
      >
        <component
