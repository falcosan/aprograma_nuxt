    ...
    <nav class="navbar">
      <div class="menu-wrapper h-0 grid grid-flow-col-dense justify-between">
        ...
        <transition enter-active-class="duration-300" leave-active-class="duration-300" enter-class="-translate-y-full" leave-to-class="-translate-y-full">
          <div v-if="expanded" :class="`menu-expanded h-10 max-w-sm xs:max-w-md sm:max-w-lg md:max-w-md lg:max-w-3xl xl:max-w-4xl 2xl:max-w-7xl w-full grid grid-flow-col overflow-hidden transform opacity-80 hover:opacity-100 transition-all ${topPosition ? 'translate-y-2 rounded' : 'rounded-b-md'}`">
