<template>
  <main class="main overflow-x-hidden">
    ...
    >
      ...
      />
      <Nuxt keep-alive :keep-alive-props="{ max: 10 }" :class="`max-w-sm xs:max-w-md sm:max-w-lg md:max-w-2xl lg:max-w-3xl xl:max-w-5xl 2xl:max-w-7xl my-0 mx-auto rounded-b ${!$device.isDesktop ? '' : 'md:rounded-t'}`" />
    </div>
