<template>
  <main class="main overflow-x-hidden">
    <div class="main-wrapper min-h-screen max-w-sm xs:max-w-md sm:max-w-lg md:max-w-xl lg:max-w-3xl xl:max-w-4xl 2xl:max-w-7xl my-10 md:my-12 mx-auto rounded-b-xl md:rounded-xl shadow-xl overflow-hidden bg-opacity-60 bg-white">
