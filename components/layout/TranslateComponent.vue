  ...
  <div id="translate" class="translate-container">
    ...
    >
      <template v-for="selector in blok">
        <span v-if="cutLanguage(selector) === $store.state.language.language || cutLanguage(selector) === 'en' && $store.state.language.language === ''" :key="selector._uid" class="language-item font-thin">
    ...
    >
      <template v-for="language in blok">
        ...
        >
          <span
            class="translate-language font-thin"
