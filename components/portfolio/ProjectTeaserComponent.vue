<template>
  <li
    v-if="projectContent"
    :class="`project-teaser w-full max-h-sm overflow-hidden rounded ${sliderContainer || carouselContainer || containerContainer ? '' : !$device.isDesktop ? '' : 'transform transition-all duration-200 hover:shadow hover:scale-105'}`"
  >
