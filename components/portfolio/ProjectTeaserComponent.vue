<template>
  <li
    v-if="projectContent"
    :class="`project-teaser max-h-md overflow-hidden rounded ${sliderContainer || carouselContainer ? '' : !$device.isDesktop ? '' : 'transform transition-all duration-200 hover:shadow hover:scale-105'}`"
  >
