<template>
  <ProjectSlider
    ...
    :blok="sortedProject"
  />
  <ul v-else-if="sortedProject" :class="`project-list grid gap-5 auto-cols-fr ${blok.row_container || parentContainer ? 'md:auto-rows-max' : containerMode ? 'md:grid-cols-big p-5' : 'md:grid-cols-big auto-rows-fr'}`">
    <ProjectTeaser
